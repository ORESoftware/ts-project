...
async.autoInject({
    ...
    removeGit: function (confirm, clone, cb) {
    ...
    install: function (confirm, replaceWithName, clone, cb) {
    ...
    replaceOrgName: function (confirm, clone, cb) {
    ...
    chmod: function (confirm, clone, cb) {
        const k = cp.spawn('bash', [], { cwd: proj });
